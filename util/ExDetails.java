...
public class ExDetails {
	...
	public static ExDetails firstStudent() {
		return new ExDetails("207776568", "Roi", "Shamayev","Roi.Shamayev@e.braude.ac.il");
	}

	// Put the second student details here
	public static ExDetails secondStudent() {
		return new ExDetails("308468826", "Nofar", "Ben Simon", "Nofar.Oshri.Bensimon@e.braude.ac.il");
